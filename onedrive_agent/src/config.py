...
class Settings(BaseSettings):
    ...
    redirect_uri: str = "http://localhost:8011/onedrive/oauth/callback"
    ...
    token_store_path: str = "./local_secrets/default_tenant/onedrive_tokens.json"
    encryption_key: Optional[str] = None
    api_prefix: str = "/onedrive"
    log_level: str = "INFO"
    log_format: str = "json"
